...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private static final int SHOW_IMAGEVIEW = 7;
    ...
    private static final int HIDE_CLICK_VIEW = 8;
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case SHOW_IMAGEVIEW:
                    ...
                    pic.setBackground(new BitmapDrawable(bm));
                    break;
                case HIDE_CLICK_VIEW:
...
//				initDecoder();
    ...
    private void initView() {
        ...
        clickView = (ImageView) findViewById(R.id.iv_click);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                mHandler.sendEmptyMessageDelayed(HIDE_CLICK_VIEW, 200);
    ...
    private synchronized void readFile(DataInputStream dis) throws IOException {
        ...
        if (bm != null) {
            ...
            mHandler.sendEmptyMessage(SHOW_IMAGEVIEW);
        }
