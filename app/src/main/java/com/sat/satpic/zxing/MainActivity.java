...
import com.sat.satpic.utils.CheckPermissionUtils;
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    if (!TextUtils.isEmpty(result)){
                        startDispayRemoteByServiceID(result);
                    }
    ...
    public void startDispayRemoteByServiceID(String remoteServiceID) {
        ...
        if (getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY) != null) {
            try {
                ...
                Toast.makeText(MainActivity.this, "Start Activity Error:" + remoteServiceID, Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(MainActivity.this, "Not found DisplayActivity:" + remoteServiceID, Toast.LENGTH_SHORT).show();
        }
    }
